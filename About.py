...
class About:
    ...
    def __init__(self, master):
        ...
        about_text = """
        - This is a word search generator that creates a word search puzzle 
        from a list of words. The words can be placed in any orientation, 
        and in any direction.
        - You can use your own words or employ AI to generate words 
        automatically.
        - If you use AI to generate words, fill in information about the topic, 
        subject, and educational level of the word, then press the AI button 
        and wait about 3 seconds to generatethe word. You can also edit the 
        words generated by AI.
        - When playing, you can click on a word in the word column on the 
        right side of the word board to get hints for that word.
        - The word search puzzle can be saved as a PDF file.
        """
